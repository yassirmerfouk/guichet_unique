...
<div class="pd-20 card-box mb-30">
	...
	<form action="../admin/ajoutercandidature.asp" method="POST">
		<div class="form-group">
			<label>Nom Candidature </label> <input class="form-control ${empty error_nom ? '' : 'form-control-danger' }" type="text" placeholder="Nom Candidature" name="nom" value="${old_nom }">
		...
		<div class="row">
			<div class="form-group col-6">
				<label>Date Ouverture</label> <input class="form-control ${empty error_dateOuverture ? '' : 'form-control-danger' }" placeholder="Select Date" type="date" name="dateOuverture"
					value="${old_dateOuverture }">
			...
			<div class="form-group col-6">
				<label>Date Limite</label> <input class="form-control ${empty error_dateLimite ? '' : 'form-control-danger' }" placeholder="Select Date" type="date" name="dateLimite" value="${old_dateLimite }">
		...
		<div class="form-group">
			<label>Date Concour</label> <input class="form-control ${empty error_dateConcour ? '' : 'form-control-danger' }" placeholder="Select Date" type="date" name="dateConcour" value="${old_dateConcour }">
